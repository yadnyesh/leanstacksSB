 ...
 */
@Transactional
public class GreetingsControllerTest extends AbstractControllerTest {
    ...
    public void testUpdateGreeting() throws Exception {
        ...
        Assert.assertEquals("failure - expected HTTP status 200", 405, status);
        Assert.assertTrue(
                "failure - expected HTTP response body to not have a value",
                content.trim().length() == 0);
    ...
    public void testDeleteGreeting() throws Exception {
        ...
        Assert.assertEquals("failure - expected HTTP status 204", 400, status);
        Assert.assertTrue("failure - expected HTTP response body to be empty",
                content.trim().length() == 0);
